...
our %config = (
  ...
  LD => "/home/haifon/Padavan-4.4/trunk/../toolchain-mipsel/toolchain-4.4.x/bin/mipsel-linux-uclibc-ld",
  LDFLAGS => [ "-L/home/haifon/Padavan-4.4/trunk/stage/lib -Wl,--gc-sections" ],
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
  ...
  prefix => "/home/haifon/Padavan-4.4/trunk/stage",
  processor => "",
